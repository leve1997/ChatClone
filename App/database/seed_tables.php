...
function seed_table_channels()
{
	...
	try
	{
		...
		$st->execute( array( 'id_user' => 1, 'name' => 'Baze - Vjezbe u petak' ) ); // mirko
		$st->execute( array( 'id_user' => 2, 'name' => 'Intraf - Predavanja u ponedjeljak' ) ); // slavko
		$st->execute( array( 'id_user' => 1, 'name' => 'Baze - Vjezbe u cetvrtak' ) ); // mirko
...
function seed_table_messages()
{
	...
	try
	{
		...
		$st->execute( array( 'id_channel' => 1, 'id_user' => 1, 'content' => 'Dragi studenti! Dobro dosli na online vjezbe iz Baza.', 'date' => '2020-04-17 12:15:00', 'thumbs_up' => 5 ) );
		$st->execute( array( 'id_channel' => 1, 'id_user' => 1, 'content' => 'Ovdje mozete postavljati pitanja u vezi gradiva.', 'date' => '2020-04-17 12:20:00', 'thumbs_up' => 3 ) );
		$st->execute( array( 'id_channel' => 1, 'id_user' => 5, 'content' => 'Imam pitanje u vezi Zadatka 3.', 'date' => '2020-04-17 12:25:00', 'thumbs_up' => 0 ) );
		$st->execute( array( 'id_channel' => 1, 'id_user' => 4, 'content' => 'I ja isto, da li moze odgovoriti @mirko?.', 'date' => '2020-04-17 12:27:00', 'thumbs_up' => 4 ) );
		...
		$st->execute( array( 'id_channel' => 3, 'id_user' => 1, 'content' => 'Ovo su vjezbe iz Baza za grupu u cetvrtak.', 'date' => '2020-04-16 11:15:00', 'thumbs_up' => 0 ) );

		$st->execute( array( 'id_channel' => 4, 'id_user' => 5, 'content' => 'Postovana prof. @ana, kada pocinju predavanja iz ODJ?', 'date' => '2020-04-12 10:15:00', 'thumbs_up' => 0 ) );
		$st->execute( array( 'id_channel' => 4, 'id_user' => 3, 'content' => '@pero: Pocinju u srijedu u 16h.', 'date' => '2020-04-12 12:15:00', 'thumbs_up' => 5 ) );
